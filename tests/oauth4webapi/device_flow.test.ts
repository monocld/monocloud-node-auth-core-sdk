...
test("deviceAuthorizationRequest()", async (t) => {
  await t.throwsAsync(
    lib.deviceAuthorizationRequest(issuer, tClient, new URLSearchParams()),
    {
  ...
  await t.notThrowsAsync(
    lib.deviceAuthorizationRequest(tIssuer, tClient, {
...
test("processDeviceAuthorizationResponse()", async (t) => {
  await t.throwsAsync(
    lib.processDeviceAuthorizationResponse(issuer, client, <any>null),
    {
  ...
  await t.notThrowsAsync(
    lib.processDeviceAuthorizationResponse(
      issuer,
      client,
      getResponse(JSON.stringify({ ...validResponse, interval: undefined }), {
        status: 200,
      })
    )
  );
  ...
  await t.throwsAsync(
    lib.processDeviceAuthorizationResponse(
      ...
      client,
      getResponse(
        JSON.stringify({ ...validResponse, device_code: undefined }),
        { status: 200 }
      )
    ),
    {
  ...
  await t.throwsAsync(
    lib.processDeviceAuthorizationResponse(
      issuer,
      client,
      getResponse(JSON.stringify({ ...validResponse, user_code: undefined }), {
        status: 200,
      })
    ),
    {
  ...
  await t.throwsAsync(
    lib.processDeviceAuthorizationResponse(
      ...
      client,
      getResponse(
        JSON.stringify({ ...validResponse, verification_uri: undefined }),
        {
          status: 200,
        }
      )
  ...
  await t.throwsAsync(
    lib.processDeviceAuthorizationResponse(
      issuer,
      client,
      getResponse(JSON.stringify({ ...validResponse, expires_in: undefined }), {
        status: 200,
      })
    ),
    {
  ...
  await t.throwsAsync(
    lib.processDeviceAuthorizationResponse(
      ...
      client,
      getResponse(
        JSON.stringify({ ...validResponse, verification_uri_complete: null }),
        {
          status: 200,
        }
      )
  ...
  await t.throwsAsync(
    lib.processDeviceAuthorizationResponse(
      issuer,
      client,
      getResponse(JSON.stringify({ ...validResponse, interval: null }), {
        status: 200,
      })
    ),
    {
...
test("deviceCodeGrantRequest()", async (t) => {
  await t.throwsAsync(
    lib.deviceCodeGrantRequest(issuer, tClient, "device_code"),
    {
...
test("deviceCodeGrantRequest() w/ Custom Headers", async (t) => {
  ...
  for (const headers of [
    ...
    await t.notThrowsAsync(
      lib.deviceCodeGrantRequest(tIssuer, tClient, "device_code", { headers })
    );
  }
});
...
test("deviceCodeGrantRequest() w/ DPoP", async (t) => {
  ...
  await t.notThrowsAsync(
    lib.deviceCodeGrantRequest(tIssuer, tClient, "device_code", { DPoP })
  );
});

test("processDeviceCodeResponse() without ID Tokens", async (t) => {
  await t.throwsAsync(
    lib.processDeviceCodeResponse(issuer, client, <any>null),
    {
      message: '"response" must be an instance of Response',
    }
  );
  ...
  await t.throwsAsync(
    lib.processDeviceCodeResponse(issuer, client, getResponse('{"')),
    {
      message: 'failed to parse "response" body as JSON',
    }
  );
  await t.throwsAsync(
    lib.processDeviceCodeResponse(issuer, client, getResponse("null")),
    {
      message: '"response" body must be a top level object',
    }
  );

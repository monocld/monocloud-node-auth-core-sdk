...
test("clientCredentialsGrantRequest()", async (t) => {
  await t.throwsAsync(
    lib.clientCredentialsGrantRequest(issuer, tClient, new URLSearchParams()),
    {
...
test("processClientCredentialsResponse()", async (t) => {
  await t.throwsAsync(
    lib.processClientCredentialsResponse(issuer, client, <any>null),
    {
  ...
  await t.throwsAsync(
    lib.processClientCredentialsResponse(issuer, client, getResponse('{"')),
    {
      message: 'failed to parse "response" body as JSON',
    }
  );
  await t.throwsAsync(
    lib.processClientCredentialsResponse(issuer, client, getResponse("null")),
    {
